...
# Installation method
declare INST64_X_APP_NAME_CAPS_X_METHOD="${INST64_X_APP_NAME_CAPS_X_METHOD:-HELM}"
# Full path to the kubectl config file with valid credentials
declare INST64_X_APP_NAME_CAPS_X_K8S_KUBECONFIG="{INST64_X_APP_NAME_CAPS_X_K8S_KUBECONFIG:-${HOME}/.kube/config}"

declare INST64_X_APP_NAME_CAPS_X_HELM_REPO='X_REPO_NAME_X'
declare INST64_X_APP_NAME_CAPS_X_HELM_SOURCE='X_REPO_SOURCE_X'
declare INST64_X_APP_NAME_CAPS_X_K8S_NAMESPACE='X_TARGET_NS_X'

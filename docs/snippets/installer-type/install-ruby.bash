...
# Installation method
declare INST64_X_APP_NAME_CAPS_X_METHOD="${INST64_X_APP_NAME_CAPS_X_METHOD:-GEM}"
declare INST64_X_APP_NAME_CAPS_X_GEM_BIN="${INST64_X_APP_NAME_CAPS_X_GEM_BIN:-/usr/bin/gem}"
declare INST64_X_APP_NAME_CAPS_X_GCC_BIN="${INST64_X_APP_NAME_CAPS_X_GCC_BIN:-/usr/bin/gcc}"

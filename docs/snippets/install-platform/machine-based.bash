...
INST64_CPU_LINUX_ARM64_GNU=''
INST64_CPU_LINUX_ARM64_MUSL=''
...
# For mac and linux
      ...
      if [[ "$BL64_OS_TYPE" == "$BL64_OS_TYPE_MACOS" && "$BL64_OS_MACHINE" == "$BL64_OS_MACHINE_ARM64" ]]; then
        ...
        INST64_X_APP_NAME_CAPS_X_PLATFORM="$INST64_CPU_LINUX_ARM64"
      fi
...
# For mac and linux with gnu and musl
      ...
      if [[ "$BL64_OS_TYPE" == "$BL64_OS_TYPE_MACOS" && "$BL64_OS_MACHINE" == "$BL64_OS_MACHINE_ARM64" ]]; then
        ...
        case "$BL64_OS_FLAVOR" in
        "$BL64_OS_FLAVOR_ALPINE" | "$BL64_OS_FLAVOR_DEBIAN" | "$BL64_OS_FLAVOR_SUSE")
          INST64_X_APP_NAME_CAPS_X_PLATFORM="$INST64_CPU_LINUX_ARM64_MUSL"
          ;;
        "$BL64_OS_FLAVOR_FEDORA" | "$BL64_OS_FLAVOR_REDHAT" | "$BL64_OS_FLAVOR_ARCH")
          INST64_X_APP_NAME_CAPS_X_PLATFORM="$INST64_CPU_LINUX_ARM64_GNU"
          ;;
        esac
      fi

...
- Installers
  ...
  - Posting
- PostgreSQL CLI
  - Added ArchOS support

### Fixed

- Installer64
  - Bootstrap: do not allow custom parameters
  - LibBL64: existing app detection
- Homebrew
...
- Installer64 **breaking-change**
  - Upgraded minimum BashLib64 version requirement to v23
...
- Upgraded Python installers to use UV method by default
- GCloud
  - Added AUR support
...
- Installers
  ...
  - OpenAI Codex
- LibBL64
  - Allow application level system wide setting: INST64\_<APP>\_SYSTEM_WIDE
